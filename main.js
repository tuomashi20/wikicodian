...
// --- 视图实现 ---
class WikicodianView extends obsidian_1.ItemView {
    ...
    onOpen() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const getActiveFileContext = () => {
                if (this.currentActiveFile && this.app.vault.adapter instanceof obsidian_1.FileSystemAdapter) {
            ...
            const handleSend = () => __awaiter(this, void 0, void 0, function* () {
                ...
                if (attachedPath) {
                    displayQuery = `📎 **附件**: \`${(_a = this.currentActiveFile) === null || _a === void 0 ? void 0 : _a.basename}.${(_b = this.currentActiveFile) === null || _b === void 0 ? void 0 : _b.extension}\`\n${query}`;
                ...
                try {
                    const response = yield fetch(`${this.settings.serverUrl}/v1/chat`, {
                        method: 'POST',
                            ...
                            for (const line of lines) {
                                if (line.startsWith('data: ')) {
                                    ...
                                    try {
                                        ...
                                        if (json.status) {
                                            botMsgEl.empty();
                                            obsidian_1.MarkdownRenderer.renderMarkdown(json.status, botMsgEl, '', this);
                                        ...
                                        if (json.output) {
                                            ...
                                            botMsgEl.empty();
                                            obsidian_1.MarkdownRenderer.renderMarkdown(fullContent, botMsgEl, '', this);
                                            this.messageContainer.scrollTo(0, this.messageContainer.scrollHeight);
                                        }
                                    }
                                    catch (e) { }
    ...
    sendConfirm(confirmId, approved, boxEl) {
        return __awaiter(this, void 0, void 0, function* () {
            boxEl.empty();
            boxEl.createEl('span', { text: approved ? "✅ 已授权执行，等待结果..." : "❌ 已拒绝执行" });
            try {
                yield fetch(`${this.settings.serverUrl}/v1/confirm`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    executeSlashCommand(cmd) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const res = yield (0, obsidian_1.requestUrl)({
    ...
    openExternalOrLocalFile(absPath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (normalizedAbs.startsWith(vaultPath)) {
                ...
                if (file instanceof obsidian_1.TFile) {
                    ...
                    new obsidian_1.Notice(`已打开文件: ${file.name}`);
                }
            }
            else {
                if (window.electron) {
    ...
    appendMessage(role, text) {
        ...
        if (role === 'user')
            ...
            obsidian_1.MarkdownRenderer.renderMarkdown(cleanText, msgEl, '', this);
        this.messageContainer.scrollTo(0, this.messageContainer.scrollHeight);
        return msgEl;
    }
}
class WikicodianPlugin extends obsidian_1.Plugin {
    onload() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    runCanvasConversion(useAi) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const activeFile = this.app.workspace.getActiveFile();
            if (!activeFile || activeFile.extension !== 'md') {
                new obsidian_1.Notice("请先打开一个 Markdown 文件");
                return;
            }
            const view = (_a = this.app.workspace.getLeavesOfType(VIEW_TYPE_WIKICODIAN)[0]) === null || _a === void 0 ? void 0 : _a.view;
            if (!view) {
                yield this.activateView();
            }
            const cmd = useAi ? `/md2canvas_ai ${activeFile.path}` : `/md2canvas ${activeFile.path}`;
            const finalView = (_b = this.app.workspace.getLeavesOfType(VIEW_TYPE_WIKICODIAN)[0]) === null || _b === void 0 ? void 0 : _b.view;
            if (finalView) {
    ...
    activateView() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!leaf) {
                ...
                if (rightLeaf) {
                    leaf = rightLeaf;
                    yield leaf.setViewState({ type: VIEW_TYPE_WIKICODIAN, active: true });
                }
            }
            if (leaf)
...
exports.default = WikicodianPlugin;
class WikicodianSettingTab extends obsidian_1.PluginSettingTab {
    constructor(app, plugin) { super(app, plugin); this.plugin = plugin; }
    display() {
        const { containerEl } = this;
        containerEl.empty();
        new obsidian_1.Setting(containerEl).setName('Backend URL').addText(text => text.setValue(this.plugin.settings.serverUrl).onChange((v) => __awaiter(this, void 0, void 0, function* () {
